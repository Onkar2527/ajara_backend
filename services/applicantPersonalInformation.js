...
function reqData(req) {
    ...
    let data = {
        ...
        IS_CURRENT_ADDRESS_ON_OVD: req.body.IS_CURRENT_ADDRESS_ON_OVD ? 1 : 0,
        ...
        IS_VERNACULAR: req.body.IS_VERNACULAR ? 1 : 0,
        ...
        IS_EMAIL_VERIFIED: req.body.IS_EMAIL_VERIFIED ? 1 : 0,
